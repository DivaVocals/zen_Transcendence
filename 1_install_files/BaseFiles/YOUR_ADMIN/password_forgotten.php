...
<?php if ($resetToken == '') { ?>
<label class="loginLabel" for="admin_email"><?php echo TEXT_ADMIN_EMAIL; ?></label>
<input style="float: left" type="text" id="admin_email" name="admin_email" value="<?php if ($error) echo zen_output_string($admin_email); ?>" autocomplete="off" />
<br class="clearBoth" />
<?php } ?>
